#!/usr/bin/env python3
"""
Windows UV Dependency installation script for Video to Transcription Service
Automatically detects CUDA version and installs appropriate PyTorch
Uses UV for package management on Windows
...
def detect_package_manager():
    """Windows UV package manager detection"""
    try:
        ...
        logger.info("Install UV: https://docs.astral.sh/uv/getting-started/installation/")
        sys.exit(1)
...
def get_uv_python():
    """Get path to Python executable in UV venv for Windows"""
...
def main():
    """Main installation process for Windows UV"""
    logger.info("=== Video to Transcription Service - Windows UV Installation ===")
    ...
    if not check_uv_python():
        ...
        logger.error("1. Install UV: https://docs.astral.sh/uv/getting-started/installation/")
...
"""]
    ...
    logger.info("📦 Package Manager: UV with Python 3.11 (Windows)")
